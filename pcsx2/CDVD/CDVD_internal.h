...
static u8 MRenewalDate[16][6] =
	{
		{0x00, 0x03, 0x01, 0x20, 0x15, 0x28,}, // 5.0, 5.1
		{0x00, 0x03, 0x03, 0x05, 0x22, 0x40,}, // 5.2, 5.3
		{0x00, 0x03, 0x04, 0x08, 0x23, 0x27,}, // 5.4, 5.5
		{0x00, 0x03, 0x06, 0x05, 0x23, 0x03,}, // 5.6, 5.7
		{0x80, 0x00, 0x00, 0x00, 0x00, 0x00,}, // 5.8, 5.9 does not exist
		{0x00, 0x03, 0x10, 0x08, 0x22, 0x00,}, // 5.10, 5.11
		{0x00, 0x03, 0x11, 0x20, 0x20, 0x05,}, // 5.12, 5.13
		{0x00, 0x04, 0x08, 0x25, 0x02, 0x12,}, // 5.14, 5.15
		{0x00, 0x04, 0x06, 0x21, 0x09, 0x53,}, // 6.0, 6.1
		{0x00, 0x04, 0x07, 0x20, 0x09, 0x04,}, // 6.2, 6.3
		{0x00, 0x04, 0x12, 0x10, 0x01, 0x30,}, // 6.4, 6.5
		{0x00, 0x05, 0x04, 0x27, 0x09, 0x17,}, // 6.6, 6.7
		{0x80, 0x00, 0x00, 0x00, 0x00, 0x00,}, // 6.8, 6.9 does not exist
		{0x00, 0x06, 0x03, 0x29, 0x06, 0x48,}, // 6.10, 6.11
		{0x00, 0x07, 0x01, 0x29, 0x03, 0x47,}, // 6.12, 6.13
		{0x00, 0x04, 0x04, 0x06, 0x13, 0x05,}, // 5.6MX, 5.7MX
};

static u8 RomverMecha[14][4] =
	{
		{0x00, 0x01, 0x02, 0x00,}, // 0100, 0101
		{0x00, 0x02, 0x04, 0x00,}, // 0110
		{0x00, 0x02, 0x04, 0x00,}, // 0120
		{0x00, 0x00, 0x00, 0x00,}, // 0130 does not exist
		{0x00, 0x00, 0x00, 0x00,}, // 0140 does not exist
		{0x00, 0x02, 0x0C, 0x00,}, // 0150
		{0x00, 0x03, 0x02, 0x00,}, // 0160
		{0x00, 0x05, 0x04, 0x00,}, // 0170
		{0x00, 0x05, 0x0A, 0x01,}, // 0180
		{0x00, 0x05, 0x04, 0x00,}, // 0190
		{0x00, 0x06, 0x04, 0x00,}, // 0200
		{0x00, 0x05, 0x0E, 0x01,}, // 0210
		{0x00, 0x06, 0x0C, 0x00,}, // 0220
		{0x00, 0x06, 0x0C, 0x00,}, // 0230, 0x250
};
